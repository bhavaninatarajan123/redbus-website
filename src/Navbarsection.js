    ...
    return(
        ...
        <header>
                ...
                <div className="head-row">
                    ...
                    <i  class="fa fa-bars" id="head-menu" aria-hidden="true"></i>
                        <div className="head-logo">
                            ...
                            <img src="../image/logo.svg" className="head-img-1"/>
                        </div>   
                        <div className="head-col-2">
                            <div className="head-background">
                            <img  className=" head-imag-2"src="../image/logo.svg"    />
                             <p> Bus Tickets</p>
                            </div>
            ...
            <div className="head-col-new">
                            <div className="head-background">
                            <img  className=" head-imag-2"src="https://st.redbus.in/web/images/layout/rb_vertical.svg"    />
                             <p> Bus Tickets</p>
                            </div>
